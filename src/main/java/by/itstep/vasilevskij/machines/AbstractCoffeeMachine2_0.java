...
import by.itstep.vasilevskij.CoffeeMachine2_0;
...
public abstract class AbstractCoffeeMachine2_0  implements CoffeeMachine2_0 {
     ...
     */
    public AbstractCoffeeMachine2_0() {
    ...
    abstract int getMilkLimit();
        ...
        //task03
        public AbstractCoffeeMachine2_0(int coffee,int coffeeBeans, int water, int milk) {
